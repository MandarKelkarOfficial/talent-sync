          ...
          <div className="md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 transition-all duration-300 hover:shadow-xl">
              ...
              <div className="flex flex-wrap gap-3">
                <Link 
                  to="/resume-analysis" 
                  className="px-4 py-2 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-lg w-56.5 font-medium hover:shadow-md transition-all duration-300 hover:-translate-y-0.5"
                >
                  Resume Analysis
                </Link>
                <Link 
                  to="/aptitude-calculator" 
                  className="px-4 py-2 w-56.5 bg-gradient-to-r from-purple-600 to-blue-600 text-white rounded-lg font-medium hover:shadow-md transition-all duration-300 hover:-translate-y-0.5"
                >
