...
// // A single file for both results components for simplicity

// const AtsSummary = ({ summary, score, matchInfo }) => {
//   if (!summary) return null;

//   return (
//     <div className="p-6 bg-white rounded-lg shadow-md w-full">
//       <h3 className="text-xl font-bold text-gray-800 mb-2">Analysis Summary</h3>
//       <div className="flex items-center mb-4">
//          <p className={`text-4xl font-bold ${matchInfo.color}`}>{score}%</p>
//          <p className={`ml-3 text-2xl font-semibold ${matchInfo.color}`}>{matchInfo.text}</p>
//       </div>
...
// const ImprovementSuggestions = ({ tips, keywords }) => {
//   if (!tips || tips.length === 0) return null;
  
//   return (
//     <div className="p-6 bg-white rounded-lg shadow-md w-full mt-6">
//       <h3 className="text-xl font-bold text-gray-800 mb-3">Improvement Suggestions</h3>
...
//          <div className="mt-4">
//             <h4 className="font-semibold text-gray-700">Matched Keywords:</h4>
...
// export { AtsSummary, ImprovementSuggestions };
